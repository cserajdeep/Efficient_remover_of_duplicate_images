  ...
  for i, imhase1 in enumerate(imghashes):
    ...
    for j, imhase2 in enumerate(imghashes):  
      if i != j and i not in visited:
        ...
        image1 = cv2.putText(image1,str(h1)+"x"+str(w1), (10,30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,255), 2, cv2.LINE_AA)
        if isgray(p):
        ...
        if z <= th:
          ...
          image2 = cv2.putText(image2,str(h2)+"x"+str(w2), (10,30), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (0,0,255), 2, cv2.LINE_AA)
          if isgray(q):
            ...
            if bright2 > bright1:
              ...
              image2 = cv2.putText(image2,"darker", (10,140), cv2.FONT_HERSHEY_SIMPLEX, 0.5, (255,0,0), 2, cv2.LINE_AA)
